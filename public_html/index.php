...
<head>
    ...
    <meta name="description"
        content="BDA(BLACK DIA COIN) is a cryptocurrency token made to connect restaurant and customer.">
    <meta name="keywords"
        content="BDA,BLACK DIA COIN,CRYPTOCURRENCY,仮想通貨,ビットコイン,BITCOIN,イーサ,ETHEREUM,ETHER,ERC20,ERC223,AIRDROP,エアドロ">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    <div class="about-text">
                        ...
                        <h3>WHITEPAPER</h3>
                        <p><a href="<?php echo($localize_hash["WHITEPAPER_LINK_01"][$language]); ?>"
                                style="color:#bea106"><i class="fa fa-download"></i>
                                <u><?php echo($localize_hash["WHITEPAPER_DOWNLOAD_01"][$language]); ?></u></a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="restaurant-roadmap">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="roadmap-section">
                        ...
                        <h4 class="roadmap-subsection-title">
                            <?php echo($localize_hash["ROADMAP_BORN_TERM_01"][$language]); ?></h4>
                        <hr>
                        <!--div class="menu-images"><img src="img/menu/beer.png" alt="Hot Drinks"></div-->
                        <div class="roadmap-item">
                            <div class="roadmap-item-name">
                                <?php echo($localize_hash["ROADMAP_BORN_TITLE"][$language]); ?></div>
                            <div class="roadmap-item-price">
                                <?php echo($localize_hash["ROADMAP_BORN_TIME"][$language]); ?></div>
                        ...
                        <div class="roadmap-item">
                            ...
                            <div class="roadmap-item-price">
                                <?php echo($localize_hash["ROADMAP_WHITEPAPER_TIME"][$language]); ?></div>
                            <div class="roadmap-item-description">
                                <?php echo($localize_hash["ROADMAP_WHITEPAPER_DETAIL"][$language]); ?></div>
                        </div>
                        <div class="roadmap-item">
                            <div class="roadmap-item-name">
                                <?php echo($localize_hash["ROADMAP_COINSWAP_TITLE"][$language]); ?></div>
                            <div class="roadmap-item-price">
                                <?php echo($localize_hash["ROADMAP_COINSWAP_TIME"][$language]); ?></div>
                            <div class="roadmap-item-description">
                                <?php echo($localize_hash["ROADMAP_COINSWAP_DETAIL"][$language]); ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div class="roadmap-section">
                        <h2 class="roadmap-section-title">2018</h2>
                        <h4 class="roadmap-subsection-title">
                            <?php echo($localize_hash["ROADMAP_BORN_TERM_02"][$language]); ?></h4>
                        <hr>
                        <!--div class="menu-images"><img src="img/menu/beer.png" alt="Hot Drinks"></div-->
                        <div class="roadmap-item">
                            <div class="roadmap-item-name">
                                <?php echo($localize_hash["ROADMAP_FINANCE_TITLE"][$language]); ?></div>
                            <div class="roadmap-item-price">
                                <?php echo($localize_hash["ROADMAP_FINANCE_TIME"][$language]); ?></div>
                            <div class="roadmap-item-description">
                                <?php echo($localize_hash["ROADMAP_FINANCE_DETAIL"][$language]); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="roadmap-section">
                        <h2 class="roadmap-section-title">
                            <?php echo($localize_hash["ROADMAP_BORN_TERM_03"][$language]); ?></h2>
                        <hr>
                        <div class="roadmap-item">
                            <div class="roadmap-item-name">
                                <?php echo($localize_hash["ROADMAP_COINEXCHANGE_TITLE"][$language]); ?></div>
                            <div class="roadmap-item-price">
                                <?php echo($localize_hash["ROADMAP_COINEXCHANGE_TIME"][$language]); ?></div>
                            <div class="roadmap-item-description">
                                <?php echo($localize_hash["ROADMAP_COINEXCHANGE_DETAIL"][$language]); ?></div>
                        </div>
                        <div class="roadmap-item">
                            <div class="roadmap-item-name">
                                <?php echo($localize_hash["ROADMAP_COINSWAP2_TITLE"][$language]); ?></div>
                            <div class="roadmap-item-price">
                                <?php echo($localize_hash["ROADMAP_COINSWAP2_TIME"][$language]); ?></div>
                            <div class="roadmap-item-description">
                                <?php echo($localize_hash["ROADMAP_COINSWAP2_DETAIL"][$language]); ?></div>
                        </div>
                        <div class="roadmap-item">
                            <div class="roadmap-item-name">
                                <?php echo($localize_hash["ROADMAP_MOREEXCHANGE_TITLE"][$language]); ?></div>
                            <div class="roadmap-item-description">
                                <?php echo($localize_hash["ROADMAP_MOREEXCHANGE_DETAIL"][$language]); ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div class="roadmap-section">
                        ...
                        <div class="roadmap-item">
                            <div class="roadmap-item-name">
                                <?php echo($localize_hash["ROADMAP_NEXT_TITLE"][$language]); ?></div>
                            <div class="roadmap-item-description">
                                <?php echo($localize_hash["ROADMAP_NEXT_DETAIL"][$language]); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="spec-section">
                        <h2 class="spec-section-title"><?php echo($localize_hash["SPEC_TOKEN_TOKEN"][$language]); ?>
                        </h2>
                        <hr>
                        <div class="spec-item">
                            <div class="spec-item-name">
                                <?php echo($localize_hash["SPEC_ETHER_TOKEN_LABEL_01"][$language]); ?></div>
                            <div class="spec-item-price">
                                <?php echo($localize_hash["SPEC_ETHER_TOKEN_DETAIL_01"][$language]); ?></div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-item-name">
                                <?php echo($localize_hash["SPEC_ETHER_TOKEN_LABEL_02"][$language]); ?></div>
                            <div class="spec-item-price">
                                <?php echo($localize_hash["SPEC_ETHER_TOKEN_DETAIL_02"][$language]); ?></div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-item-name">
                                <?php echo($localize_hash["SPEC_ETHER_TOKEN_LABEL_03"][$language]); ?></div>
                            <div class="spec-item-price">
                                <?php echo($localize_hash["SPEC_ETHER_TOKEN_DETAIL_03"][$language]); ?></div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-item-name">
                                <?php echo($localize_hash["SPEC_ETHER_TOKEN_LABEL_05"][$language]); ?></div>
                            <div class="spec-item-price">ERC20/223</div>
                            <div class="spec-item-description"><span
                                    id="coin-contract"><?php echo($localize_hash["SPEC_ETHER_TOKEN_DETAIL_05"][$language]); ?></span>
                            </div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-item-name" style="color:#dddddd">
                                <?php echo($localize_hash["SPEC_ETHER_TOKEN_LABEL_04"][$language]); ?></div>
                            <div class="spec-item-price" style="color:#dddddd">ERC20/223</div>
                            <div class="spec-item-description" style="color:#dddddd"><span
                                    id="coin-contract"><?php echo($localize_hash["SPEC_ETHER_TOKEN_DETAIL_04"][$language]); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="spec-section">
                        <h2 class="spec-section-title">
                            <?php echo($localize_hash["SPEC_TOKEN_ALLOCATION"][$language]); ?></h2>
                        <hr>
                        <div class="spec-item">
                            <div class="spec-item-name"><?php echo($localize_hash["SPEC_DEVELOP_TITLE"][$language]); ?>
                            </div>
                            <div class="spec-item-price">30%</div>
                            <div class="spec-item-description">
                                <?php echo($localize_hash["SPEC_DEVELOP_DETAIL"][$language]); ?></div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-item-name"><?php echo($localize_hash["SPEC_SELLEXC_TITLE"][$language]); ?>
                            </div>
                            <div class="spec-item-price">45%</div>
                            <div class="spec-item-description">
                                <?php echo($localize_hash["SPEC_SELLEXC_DETAIL"][$language]); ?></div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-item-name">
                                <?php echo($localize_hash["SPEC_MARKETING_TITLE"][$language]); ?></div>
                            <div class="spec-item-price">15%</div>
                            <div class="spec-item-description">
                                <?php echo($localize_hash["SPEC_MARKETING_DETAIL"][$language]); ?></div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-item-name"><?php echo($localize_hash["SPEC_TEAM_TITLE"][$language]); ?>
                            </div>
                            <div class="spec-item-price">10%</div>
                            <div class="spec-item-description">
                                <?php echo($localize_hash["SPEC_TEAM_DETAIL"][$language]); ?></div>
                        </div>
                    </div>
                </div>
            </div>
